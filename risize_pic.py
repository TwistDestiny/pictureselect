...
class CanvasImage:
    ...
    def __init__(self, placeholder, path):
        ...
        self.canvas.configure(width=w_box -20,height=h_box - 30,)
        ...
        event__  = Event_(20,20,-120)
        for i in range(3):
            self.__wheel(event=event__)
        self.__move_from(event=Event_(1000,20,20))
        self.__move_to(event=Event_(100, 280, 20))
...
#
# filename  = 'welcome.jpg'  # place path to your image here
